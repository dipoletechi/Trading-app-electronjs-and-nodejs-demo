...
@Component({
    ...
    styleUrls: [
        './anychart.component.css',
        '../../../node_modules/anychart/dist/css/anychart-ui.min.css',
        '../../../node_modules/anychart/dist/fonts/css/anychart-font.min.css',
    ],
    encapsulation: ViewEncapsulation.None
})
export class AnyChartComponent implements AfterViewInit {

    table: anychart.data.Table = anychart.data.table();
    mapping = this.table.mapAs();
    chart: anychart.charts.Stock = null;
    ...
    constructor() {
        ...
        this.mapping.addField('open', 1);
        this.mapping.addField('high', 2);
        this.mapping.addField('low', 3);
        this.mapping.addField('close', 4);
    }
    ...
    private loadChart()
    {
        ...
        var series = this.chart.plot(0).candlestick(this.mapping);
        series.name("ACME Corp. stock prices");
        this.chart.draw();
        this.chart.background().fill("black");
    }
}